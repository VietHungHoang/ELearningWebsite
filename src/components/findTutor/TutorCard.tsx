      ...
      <div className="p-6">
        ...
        <div className="flex items-center space-x-4 mb-3 text-sm text-gray-500">
          <div className="flex items-center">
            ...
            <span>{tutor.rating}/5.0 ({tutor.reviewCount} review{tutor.reviewCount !== 1 ? 's' : ''})</span>
          </div>
        </div>
        ...
        <div className="mb-4">
          <p className="text-sm text-gray-500">
            <span className="font-medium">Languages I Know:</span> {tutor.languages.join(', ')}
          </p>
        </div>
        ...
        <div className="flex space-x-3">
          <button className="flex-1 bg-[#134E4A] text-white px-4 py-2 rounded-lg font-medium hover:bg-[#0F3A36] transition-colors flex items-center justify-center">
