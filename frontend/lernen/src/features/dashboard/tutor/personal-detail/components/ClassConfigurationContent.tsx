...
interface ClassConfigurationContentProps {
    onSave: () => void;
}

const ClassConfigurationContent: React.FC<ClassConfigurationContentProps> = ({ onSave }) => {
...
export default ClassConfigurationContent;