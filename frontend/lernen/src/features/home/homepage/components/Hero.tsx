    ...
    <section className="max-w-7xl mx-auto px-4 py-8">
      <div className="grid grid-cols-1 lg:grid-cols-[52%_48%] gap-30 items-center">
        ...
        <div className="text-center lg:text-left">
          {/* Badge */}
          <div className="inline-flex items-center bg-gray-100 rounded-full px-4 py-1.5 text-xs font-semibold text-gray-700 animate-fade-in-up">
          ...
          {/* Main Heading */}
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-800 mt-5 leading-tight animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
          ...
          {/* Subheading */}
          <p className="mt-4 text-base text-gray-600 max-w-xl mx-auto lg:mx-0 leading-relaxed animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
          ...
          <div className="mt-6 relative max-w-lg mx-auto lg:mx-0 animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
            <div className="relative group">
              <input
                ...
                className="w-full pl-5 pr-16 py-3.5 text-sm bg-white border-2 border-gray-200 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-[#0b6459] focus:border-transparent transition-all hover:shadow-md"
              />
          ...
          {/* Trust Indicators */}
          <div className="mt-6 flex flex-wrap items-center justify-center lg:justify-start gap-4 text-xs text-gray-600 animate-fade-in-up" style={{ animationDelay: '0.8s' }}>
