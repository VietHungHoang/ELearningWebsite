...
export const TutorHeroPanel: React.FC = () => {
    return (
        <div className="relative w-full max-w-lg mx-auto">
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-2xl aspect-[4/3] group border-4 border-white/20 backdrop-blur-sm bg-gradient-to-br from-[#0b6459]/20 via-teal-600/20 to-emerald-600/20">
                <img 
                ...
                />
                {/* Overlay gradient */}
                <div className="absolute inset-0 bg-gradient-to-t from-[#0b6459]/60 via-[#0b6459]/20 to-transparent"></div>
                ...
                <div className="absolute inset-0 flex flex-col justify-end p-6">
                    <div className="bg-white/95 backdrop-blur-md rounded-xl p-4 shadow-xl">
                        <div className="flex items-center justify-between mb-3">
                            <div>
                                <p className="text-xs text-gray-600 font-medium">Average Monthly Earnings</p>
                                <p className="text-2xl font-bold text-[#0b6459] mt-1">$2,450</p>
                            </div>
            ...
            <div className="absolute -top-4 -left-4 bg-white/95 backdrop-blur-md p-4 rounded-xl shadow-xl z-20 border border-gray-100 animate-float">
                <div className="flex items-center gap-3">
                    <div className="w-12 h-12 bg-gradient-to-br from-[#0b6459] to-teal-600 rounded-lg flex items-center justify-center">
                        <FiDollarSign className="text-white" size={24} />
                    </div>
                    <div>
                        <p className="text-gray-600 text-xs font-medium">Set Your Rate</p>
                        <p className="text-lg font-bold text-gray-800">$25-100/hr</p>
                    </div>
                </div>
            </div>
            ...
            <div className="absolute -top-4 -right-4 bg-white/95 backdrop-blur-md p-3 rounded-xl shadow-xl z-20 border border-gray-100 max-w-[220px] animate-float" style={{ animationDelay: '0.2s' }}>
                <div className="flex items-start gap-2.5">
                    ...
                    <div className="flex-1 min-w-0">
                        <p className="font-bold text-xs text-gray-800 truncate">Sarah M.</p>
                        <p className="text-[10px] text-gray-600 truncate">Math Tutor</p>
                        <div className="flex items-center gap-1 mt-1">
                            <AiFillStar size={12} className="text-orange-500" />
                            <span className="text-xs font-bold text-gray-800">4.9</span>
                            <span className="text-[10px] text-gray-500 ml-1">(250+)</span>
                        </div>
                        <p className="text-[10px] text-gray-600 mt-1 line-clamp-2">"Earning $3k/month teaching part-time!"</p>
                    </div>
                </div>
            </div>
        </div>
