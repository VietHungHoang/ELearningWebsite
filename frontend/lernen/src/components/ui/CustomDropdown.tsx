...
const CustomDropdown: React.FC<CustomDropdownProps> = ({ label, options, selectedValue, placeholder, onSelect, dropdownId, openDropdown, setOpenDropdown, hasSearch = false, searchPlaceholder = "Search..." }) => {
    ...
    return (
        <div className="relative" ref={dropdownRef}>
            ...
            `}>
                ...
                >
                    <span className={`dropdown-label text-sm font-medium truncate ${isPlaceholder && label ? 'text-[rgba(88,88,88,0.4)]' : 'text-[#585858]'}`}>{selectedValue}</span>
