...
public interface ClassEnrollmentRepository extends JpaRepository<ClassEnrollment, UUID> {
        ...
        Optional<ClassEnrollment> findByTutorIdAndStudentId(@Param("tutorId") UUID tutorId,
        ...
        Long countDistinctStudentsByTutorIdAndDateRange(@Param("tutorId") UUID tutorId,
        ...
        List<Object[]> getMonthlyStudentStats(@Param("tutorId") UUID tutorId,
