...
public class ElasticsearchConfig {
        ...
        private TypeMapping buildMappings() {
                return TypeMapping.of(tm -> tm
                                ...
                                // Headline fields
                                .properties("headlineVi",
                                                Property.of(p -> p.text(t -> t.analyzer("vietnamese_analyzer"))))
                                .properties("headlineEn", Property.of(p -> p.text(t -> t.analyzer("english_analyzer"))))
                                .properties("headlineJa",
                                                Property.of(p -> p.text(t -> t.analyzer("japanese_analyzer"))))

                                // Introduction fields
                                .properties("introductionVi",
                                                Property.of(p -> p.text(t -> t.analyzer("vietnamese_analyzer"))))
                                .properties("introductionEn",
                                                Property.of(p -> p.text(t -> t.analyzer("english_analyzer"))))
                                .properties("introductionJa",
                                                Property.of(p -> p.text(t -> t.analyzer("japanese_analyzer"))))

                                // Filters
                                .properties("languageCodes", Property.of(p -> p.keyword(k -> k)))
                                .properties("categoryIds", Property.of(p -> p.keyword(k -> k)))
                                .properties("subjectIds", Property.of(p -> p.keyword(k -> k)))
