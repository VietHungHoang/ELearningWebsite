...
## Overview
Content Service quản lý tất cả nội dung multimedia trong hệ thống E-learning, bao gồm upload video chunked lên S3, upload ảnh thumbnail cho khóa học, xử lý content và streaming.
...
```properties
# Database
spring.datasource.url=jdbc:postgresql://localhost:5432/content_service_db
