...
public class NotificationController {
        ...
        public ResponseEntity<ApiResponse<List<NotificationResponse>>> getUserNotifications(
                ...
                ApiResponse<List<NotificationResponse>> response = ApiResponse.success(notifications,
        ...
        public ResponseEntity<ApiResponse<Long>> getUnreadCount(@PathVariable Long userId) {
                ...
                ApiResponse<Long> response = ApiResponse.success(count, "Fetch unread count successfully.");
        ...
        public ResponseEntity<ApiResponse<Long>> markAllAsRead(@PathVariable Long userId) {
                ...
                ApiResponse<Long> response = ApiResponse.success(updatedCount, "All notifications marked as read.");
