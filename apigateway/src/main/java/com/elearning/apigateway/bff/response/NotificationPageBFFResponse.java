...
/**
 * DTO Notification Page Response - Tổng hợp notifications đầy đủ
 * Bao gồm:
...
public class NotificationPageBFFResponse {
    ...
    private Map<String, List<NotificationDetailDTO>> notificationsByType; // Grouped by type
    private Map<String, List<NotificationDetailDTO>> notificationsByDate; // Grouped by date
